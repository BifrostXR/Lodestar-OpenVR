...
All tracked poses will be relative to your Anchors, not your headset's playspace. In order to align Lodestar to your playspace you can use [Space Calibrator](https://github.com/pushrax/OpenVR-SpaceCalibrator). Also available on [Steam](https://store.steampowered.com/app/3368750/Space_Calibrator/). Be warned however, that Space Calibrator doesn't always play nicely with Lodestar and may take some work to get the spaces aligned, especially with a Anchor calibration. This is something we are actively working on resolving. For best alignment, rigidly mount a Lodestar tracker to your headset and use the continuous calibration mode.
